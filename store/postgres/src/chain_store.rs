...
mod data {
    ...
    impl Storage {
        ...
        pub fn clear_stale_call_cache(
            ...
            // Note: Maybe make the batch size configurable via an env var
            ...
            match self {
                Storage::Shared => {
                    ...
                    // Delete stale meta entries. Doing it in a single operation should be fine since it's one entry per contract
                    diesel::delete(
